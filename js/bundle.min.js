...
},{"./helpers/bind":15,"is-buffer":69}],26:[function(require,module,exports){
/**
 * @namespace Chart
 */
...
},{"./charts/Chart.Bar":27,"./charts/Chart.Bubble":28,"./charts/Chart.Doughnut":29,"./charts/Chart.Line":30,"./charts/Chart.PolarArea":31,"./charts/Chart.Radar":32,"./charts/Chart.Scatter":33,"./controllers/controller.bar":34,"./controllers/controller.bubble":35,"./controllers/controller.doughnut":36,"./controllers/controller.line":37,"./controllers/controller.polarArea":38,"./controllers/controller.radar":39,"./core/core.animation":40,"./core/core.canvasHelpers":41,"./core/core.controller":42,"./core/core.datasetController":43,"./core/core.element":44,"./core/core.helpers":45,"./core/core.js":46,"./core/core.layoutService":47,"./core/core.legend":48,"./core/core.plugin.js":49,"./core/core.scale":50,"./core/core.scaleService":51,"./core/core.title":52,"./core/core.tooltip":53,"./elements/element.arc":54,"./elements/element.line":55,"./elements/element.point":56,"./elements/element.rectangle":57,"./scales/scale.category":58,"./scales/scale.linear":59,"./scales/scale.linearbase.js":60,"./scales/scale.logarithmic":61,"./scales/scale.radialLinear":62,"./scales/scale.time":63}],27:[function(require,module,exports){
"use strict";
...
},{"chartjs-color":65}],46:[function(require,module,exports){
"use strict";
...
},{"moment":70}],64:[function(require,module,exports){
/* MIT license */
...
var App = function () {
  function App(elems, results) {
    _classCallCheck(this, App);

    this.elems = elems;
    this.quest = results;
    this.dash = new _dashboard2.default();
  ...
  _createClass(App, [{
    ...
    value: function loadModal() {
      var show = document.querySelectorAll('.modal-open');
      var hide = document.querySelectorAll('.modal-close');

      Array.from(show).forEach(function (link) {
        link.addEventListener('click', function (e) {
          e.preventDefault();
          var klass = link.dataset.modal;
          var modal = document.querySelector('#' + klass);
          modal.classList.add('is-active');
        });
      });

      Array.from(hide).forEach(function (link) {
        link.addEventListener('click', function (e) {
          e.preventDefault();
          var klass = link.dataset.modal;
          var modal = document.querySelector('#' + klass);
...
},{"./dashboard":73}],73:[function(require,module,exports){
'use strict';
...
var Dashboard = function () {
  ...
  _createClass(Dashboard, [{
    key: 'displayCalendar',
    value: function displayCalendar(location, days) {
      var calendar = jsCalendar.new(location, "now", {
    ...
    key: 'displayChart',
    value: function displayChart(type, location, quest) {
      switch (type) {
        case 'quest':
    ...
    key: 'displayProgress',
    value: function displayProgress(location, stat) {
      var elem = document.getElementById(location);
      elem.innerHTML = '\n      <progress class="progress is-info" value="' + stat + '" max="1000"></progress>\n    ';
    }
  }, {
    key: 'displayStat',
    value: function displayStat(location, stat) {
      var elem = document.getElementById(location);
      elem.innerHTML = stat;
    }
  }, {
    key: 'displayUpdateAt',
    value: function displayUpdateAt(location, date) {
      var elem = document.getElementById(location);
      var updatedAt = (0, _moment2.default)(Number(date)).format('MMMM D, YYYY');
      elem.innerHTML = updatedAt;
    }
  }, {
    key: 'displayWeightGoal',
    value: function displayWeightGoal(location, percentage) {
      var elem = document.getElementById(location);
    ...
    key: 'questChart',
    value: function questChart(location, quest) {
      var ctx = document.getElementById(location);
      var len = quest.bench.dataset.length;
      ...
      new _chart2.default(ctx, { type: 'line', data: data });
    }
  }]);
...
},{"chart.js":26,"moment":70}],74:[function(require,module,exports){
'use strict';
...
// Data URL
var url = 'https://quest1k.herokuapp.com/data';
...
axios.get(url).then(function (response) {
  ...
  new _app2.default(elems, response.data).init();
